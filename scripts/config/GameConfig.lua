...
GameConfig.LocationItems = {
    school = {
        ...
        { id = "chicken_strip", name = "鸡柳",   emoji = "🍖",
          batchCost = 35,  yield = 30, unitPrice = 5,  salesRange = { 20, 35 },
          energyCost = 5,  moodCost = 1,  unlockMonth = 1, unlockDay = 3, skillReq = {} },
        { id = "chicken_steak", name = "鸡排",   emoji = "🥩",
